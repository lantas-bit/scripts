Settings = {
  -- Shout out to Swipez for creating the original source code
  -- Improved by Lantas (gabisa code, cuma bisa share sc orang)
  
  WebhookURL = "https://discord.com/api/webhooks/",
  
  World = {
    -- int "string" (e.g "PRO" / "KODIR")
    Geiger = "GEIGERP",
    Save = "LANTAS333"
  },
  ...
  QoL = {
    ...
    DropGeiger = true, -- Auto drop dead geiger if reaching 245
    ChargeGeiger = false, -- Auto charge dead geiger
    UseWebhook = true, -- Auto send webhook
  },
  
  Pos = {
    -- int num (e.g 13 73)
    AliveGeiger = {34, 24}, -- Position for taking alive geiger
    DeadGeiger = {44, 16}, -- Position for dropping dead geiger
    Valuable = {38, 24} -- Position for dropping valuable items
  },
  
  Delay = {
    -- int num
    Rejoin = 5000, -- Delay reconnecting
    FindPath = 800 -- Delay between findpath
  },
}
